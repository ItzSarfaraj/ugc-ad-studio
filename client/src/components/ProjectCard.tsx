    ...
    <div key={gen.id} className="mb-4 break-inside-avoid">
      <div className="bg-white/5 border border-white/10 rounded-xl overflow-hidden hover:border-white/20 transition group">
        ...
        >
          ...
          {/* status badge */}
          <div className="absolute left-3 top-3 flex gap-3 items-center">
            {gen.isGenerating && (
          ...
          {/* Action Menu- For myGenerations only */}
          {!forCommunity && (
            <div
              onMouseDownCapture={() => {
                setMenuOpen(true);
            ...
            >
              ...
              <div className="flex flex-col items-end w-32 text-sm">
                <ul
                  className={`text-xs ${menuOpen ? "block" : "hidden"} overflow-hidden right-0
                        peer-focus:block hover:black w-40 bg-black/50 backdrop-blur-2xltext-white border border-gray-500/50 rounded-lg shadow-md mt-2 py-1 z-10`}
                >
                  {gen.generatedImage && (
                    <a
        ...
        <div className="p-4">
          ...
          {/* buttons- only for myGenerations */}
          {!forCommunity && (
