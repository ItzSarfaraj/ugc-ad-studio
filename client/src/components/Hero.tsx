...
export default function Hero() {
  ...
  const mainImageUrl =
    "https://images.unsplash.com/photo-1622940901317-05752dc8627b?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";

  const galleryStripImages = [
    "https://images.unsplash.com/photo-1523275335684-37898b6baf30?q=80&w=100", // watch/product
    "https://images.unsplash.com/photo-1512436991641-6745cdb1723f?q=80&w=100", // fashion
    "https://images.unsplash.com/photo-1521572267360-ee0c2909d518?q=80&w=100", // lifestyle
  ];
        ...
        <div className="max-w-6xl mx-auto px-4 min-h-screen max-md:w-screen max-md:overflow-hidden pt-32 md:pt-26 flex items-center justify-center">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div className="text-left">
              ...
              >
                Upload product images and model photo- our AI instantly produces
                professional lifestyle imagery and short-form videos optimised
