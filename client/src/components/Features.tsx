    ...
    return (
        <section id="features" className="py-20 2xl:py-32">
            <div className="max-w-6xl mx-auto px-4">
                ...
                <Title
                    title="Features"
                    heading="Built for modern brand"
                    description="our AI instantly produces professional lifestyle imagery and short-form videos optimised for commercials and Reels"
                />
